...
@section('main')
    <div class="container">
        ...
        <button type="button" class="btn btn-primary mb-3 me-auto d-block" data-bs-toggle="modal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" step="0.01" name="items[0][price]"
                                            class="form-control price-input" placeholder="السعر" required>
                                    </div>
                                    <!-- Quantity Input -->
                                    <div class="col-md-2">
                                        <label>الكمية</label>
                                        <input type="number" step="0.01" name="items[0][quantity]" class="form-control"
                                            placeholder="الكمية" min="0.01" required>
                                    </div>
                                    <!-- Type Selection -->
                                    <div class="col-md-2">
                                        <label>النوع</label>
